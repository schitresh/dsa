...
# items in a knapsack of capacity W to get the maximum total profit.
...
examples = [
  {
    'input': [50, [[60, 10], [100, 20], [120, 30]]], # Knapsack weight, [[profit, weight]]
    'output': 240
...
# Greedy
# Calculate the ratio of profit/weight for each item and sort the items based on this
# ratio.
# Take the item with the highest ratio and add them as much as we can (can be the whole
# element or a fraction of it).
