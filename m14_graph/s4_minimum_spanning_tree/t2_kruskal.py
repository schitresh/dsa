...
# Sort all edges of the graph in increasing order. Keep on adding new edges (or nodes)
# if it doesn't create a cycle. Use Union-Find algorithm to detect cycles.
# Thus, it makes a locally optimal choice in each step to find the optimal solution.
# Hence, this is a greedy algorithm.

examples = [
  {
    'input': [[[4, 0, 1], [1, 0, 3], [3, 1, 2], [2, 3, 2], [2, 2, 4]]], # [weight, x, y]
    'output': 8
  }
]
