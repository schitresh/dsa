...
# Sort all the edges in descending order of weights, and pick edges one by one. Include
# the current edge if excluding it causes disconnection in the graph. Put another way,
# keep deleting edges if the deletion does not disconnect the graph.
