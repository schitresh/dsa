...
# There are N Mice and N holes placed in a straight line
...
examples = [
  {
    ...
    'output': 4 # Assign m4 to h4 (0 mins), m(-4) to h0 (4 mins), m2 to h5 (3 mins)
  },
  {
...
# This works since we need to minimize the last mouse,
# and that will be achieved when every mouse goes to the nearest hole possible
